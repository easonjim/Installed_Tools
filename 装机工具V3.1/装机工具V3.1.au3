...
#Region 
#AutoIt3Wrapper_icon=
#AutoIt3Wrapper_outfile=装机工具V3.1 X64.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_UseX64=y
#AutoIt3Wrapper_Res_Comment=装机工具V3.1
...
#Include <GuiListView.au3>
DirCreate(@WindowsDir & "\temp\Systemtools")
Opt("TrayIconHide", 1)
Global $Systemtools = @WindowsDir & "\temp\Systemtools"
...
Sleep(500)
ProgressOff()
$CPU = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","中央处理器(CPU)","中央处理器(CPU)|处理器名称","")
$beiqiao = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","芯片组","芯片组1|北桥属性|北桥","")
$nanqiao = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","芯片组","芯片组2|南桥属性|南桥","")
$Vidao = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","PCI/AGP 视频","PCI/AGP 视频1","")
$Audio = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","PCI/PnP 音频","PCI/PnP 音频1","")
$Network = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","PCI/PnP 网络","PCI/PnP 网络1","")
$waiwangip = _GetIP()
...
$Form1_1 = GUICreate("装机工具V3.1 by Eason", 586, 507, 222, 136)
...
_GUICtrlListView_SetColumnWidth($ListView1,1,410)
...
Func echo()
	...
	ProgressSet($i,"正在导入中...")
	Next
	$CPUC = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","中央处理器(CPU)","中央处理器(CPU)|处理器名称","")
	$beiqiaoC = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","芯片组","芯片组1|北桥属性|北桥","")
	$nanqiaoC = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","芯片组","芯片组2|南桥属性|南桥","")
	$VidaoC = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","PCI/AGP 视频","PCI/AGP 视频1","")
	$AudioC = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","PCI/PnP 音频","PCI/PnP 音频1","")
	$NetworkC = IniRead(@WindowsDir & "\temp\Systemtools\AIDA64\Reports\Report.ini","PCI/PnP 网络","PCI/PnP 网络1","")
	$waiwangipC = _GetIP()
