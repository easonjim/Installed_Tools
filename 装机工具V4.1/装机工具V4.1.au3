...
#AutoIt3Wrapper_outfile=装机工具V4.1 X86&X64.exe
#AutoIt3Wrapper_Res_Comment=装机工具V4.1
...
$waiwangip = _GetIP()
$Fb = IniReadSection($Systemtools & "\Resolution.ini","Resolution")
;皮肤调用
...
$Form1_1 = GUICreate("装机工具V4.1 by Eason", 586, 507, 222, 136)
...
$Label3 = GUICtrlCreateLabel("说明:如果不小心点错，导致电脑黑屏，无法点恢复按扭，请直接按Ctrl+R键恢复调节前设置"&@CR&"1、（CRT）显示器17寸普屏（4：3），最佳分辨率为1024X768。"&@CR&"2、（LCD）17寸和19寸普屏（5：4），最佳分辨率是1280×1024。"&@CR&"3、（LCD）19寸宽屏（16：10），最佳分辨率是1440×900。"&@CR&"4、（LCD）22寸宽屏（16：10），最佳分辨率是1680×1050。"&@CR&"5、1280×800，这是13.3吋、14.1吋笔记本屏幕常用的分辨率。"&@CR&"6、1366×768、1920×1080、1600×900等是16:9宽屏的分辨率。"&@CR&"7、1024×600，是9寸10寸上网本的分辨率。"&@CR&"8、1920×1200，是24寸宽屏（16：10）液晶的分辨率。"&@CR&"9、2560x1440，苹果27寸专用。"&@CR&"10、2560x1600，30寸液晶专用。", 32, 230, 516, 210)
